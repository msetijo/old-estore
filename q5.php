...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="style/q5.css" />
		<script src="script/q5.js" type="text/javascript"> </script>
	...
	<body onload="makeDate()">
		...
		<div id="container">
			...
			<div id="content"> 
				...
				<p><b>$16.55</b></p>
				<a href="cart.php?itemid=1">Add To Cart</a>
				<p class="clear"></p>
				...
				<p><b>$19.99</b></p>
				<a href="cart.php?itemid=2">Add To Cart</a>
				<p class="clear"></p>
				...
				<p><b>$17.65</b></p>
				<a href="cart.php?itemid=3">Add To Cart</a>
				<p class="clear"> </p>
